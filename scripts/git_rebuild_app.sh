...
# Description:
# This script pulls the latest changes from git, then rebuilds a Next.js application by removing existing build artifacts,
...
LOG_FILE="${LOG_DIR}/pages_git_rebuild_app.log" # Absolute path to log file
...
log_message "Starting git pull and application rebuild process."
...
log_message "Pulling latest changes from git main branch"
sudo git pull origin main
check_error "Failed to pull latest changes from git"
...
log_message "Git pull and application rebuild completed successfully."
