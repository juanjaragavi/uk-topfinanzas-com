          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="my-8 text-left sm:text-left">
              ...
              <section className="my-6">
                ...
                <p className="text-left sm:text-left text-gray-800 mb-4 text-sm leading-6 font-light">
                  Consider your total package too: pension contributions, annual leave, flexible working, and training opportunities all have financial value. If your employer can't stretch the base salary, they may offer improvements in other areas that still benefit your overall{" "}
                  <Link
              ...
              <section className="my-6">
                ...
                <p className="text-left sm:text-left text-gray-800 mb-4 text-sm leading-6 font-light">
                  If your manager agrees, confirm the details in writing: the new amount, effective date, and any conditions attached. Update your personal budget and review your{" "}
                  <Link
                ...
                <p className="text-left sm:text-left text-gray-800 mb-4 text-sm leading-6 font-light">
                  If you're repeatedly met with vague excuses and no action, it may be time to quietly explore other opportunities. A rejection today doesn't mean you're not valuable — it might just mean your employer can't (or won't) meet your worth. Building strong{" "}
                  <Link
                  ...
                  {" "}now will give you the financial flexibility to make the best move for your career.
                </p>
              </section>
