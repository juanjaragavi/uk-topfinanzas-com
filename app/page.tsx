...
const allPosts: PostData[] = [
  // Select a subset of posts for the homepage (e.g., 6-8 most recent/relevant)
  // Sorted manually by date (most recent first) for this example
  {
  ...
  },
  {
    ...
    frontmatter: {
      ...
      date: "2025-04-03T00:00:00Z",
      featuredImage:
        "https://us.topfinanzas.com/wp-content/uploads/2025/02/APR.webp", // Placeholder
      categories: [{ name: "Personal Finance", slug: "personal-finance" }],
    },
    category: "Personal Finance",
    categoryPath: "/personal-finance",
