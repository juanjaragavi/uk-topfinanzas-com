          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <AnimatedText as="h2" className="mb-6 text-secondary">
                Finding the right credit card is a key step toward financial success
              </AnimatedText>

              <AnimatedText as="p" className="mb-4 text-gray-600" delay={0.1}>
                With our recommender, you'll gain access to tailored suggestions that match your needs—helping you save
                money and build a brighter financial future.
              </AnimatedText>

              <AnimatedText as="p" className="mb-6 text-gray-600" delay={0.2}>
                Our recommender connects you with tailored options to fit your needs. From saving on interest to earning
                rewards or avoiding fees, we make choosing the right card simple and confident.
              </AnimatedText>
