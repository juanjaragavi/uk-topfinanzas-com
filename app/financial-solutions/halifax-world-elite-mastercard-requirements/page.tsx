            ...
            <div className="my-8 text-left sm:text-left">
              ...
              <section className="my-6">
                ...
                <div className="space-y-6 my-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      This premium card is typically offered to existing Halifax
                      Ultimate Reward Current Account holders or Halifax Premier
                      account customers. This requirement ensures the card is
                      provided to established customers with a demonstrated
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      card and ensures cardholders have sufficient income to
                      benefit from and manage the card's features.
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 my-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      confirm your current residential address for verification
                      purposes.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      premium card, demonstrating a pattern of responsible
                      credit management.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      ability to manage the credit limit and eligibility for
                ...
                <div className="space-y-6 my-8">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      Mastercard as part of the package.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      relation to the benefits offered by the card.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      A fee of 2.5% (minimum £2.50) applies for cash
                      withdrawals, making this an option to consider only when
                      necessary.
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 my-8">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      Comprehensive coverage for you and your family, including
                      medical expenses, trip cancellation, lost luggage, and
                      travel accidents. This premium protection ensures peace of
                      mind during all your journeys.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      productive pre-flight experience regardless of your ticket
                      class.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5 text-left">
                      ...
                      planning. This time-saving benefit helps you manage your
                ...
                <p className="text-gray-800 mb-4 text-sm leading-5 font-light text-left">
                  ...
                  savings on travel insurance premiums and airport lounge day
                  passes alone can easily offset the annual fee for frequent
                  travellers.
                </p>
                ...
                <p className="text-gray-800 mb-4 text-sm leading-5 font-light text-left">
                  ...
                  this service can enhance your lifestyle while reducing the
                ...
                <p className="text-gray-800 mb-4 text-sm leading-5 font-light text-left">
                  ...
                  protections create an additional layer of security beyond what
                ...
                <p className="text-gray-800 mb-4 text-sm leading-5 font-light text-left">
                  ...
                  substantial, the comprehensive benefits package can deliver
                  exceptional value for certain customers, particularly those
                  who travel frequently and appreciate premium services and
                  protections.
                </p>
