            ...
            <div className="my-8">
              ...
              <section className="my-6">
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      ...
                      levels who are likely to benefit from its travel rewards
                      and features.
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      ...
                      ability to manage the credit limit.
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 mb-8">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      ...
                      be redeemed for flights, upgrades, hotels, and more
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      ...
                      Receive a complimentary cabin upgrade voucher when you
                      spend £10,000 in a membership year, enhancing your travel
                ...
                <p className="text-gray-800 mb-4 text-sm leading-5 font-light">
                  ...
                  earn 1.5 Avios per £1 spent means that everyday purchases
                  contribute to future travel experiences, making it an
                ...
                <p className="text-gray-800 mb-4 text-sm leading-5 font-light">
                  ...
                  potential make it a valuable financial tool for those with
                ...
                <p className="text-gray-800 mb-4 text-sm leading-5 font-light">
                  ...
                  combined with worldwide travel insurance and airport lounge
                  access discounts, creates a comprehensive travel companion
                  that provides both convenience and security for international
                  journeys.
                </p>
                ...
                <p className="text-gray-800 mb-4 text-sm leading-5 font-light">
                  ...
                  substantial benefits for certain types of consumers, but its
                  annual fee means you should carefully assess whether you'll
