              ...
              <div className="space-y-2 mb-8">
                <div className="flex items-start">
                  ...
                  <div className="text-md leading-5">
                    ...
                    Receive real-time alerts for all transactions, helping you track spending and quickly identify unauthorized charges the moment they happen.
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="text-md leading-5">
                    ...
                    Set spending budgets by category, monitor your progress in real-time, and receive insights on your spending patterns to help you manage your finances.
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="text-md leading-5">
                    ...
                    Manage your credit card alongside your Monzo current account in a single, intuitive app, with unified spending insights and simplified payments.
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="text-md leading-5">
                    <span className="font-semibold">No Foreign Transaction Fees:</span>{" "}
                    Use your Monzo Credit Card abroad without incurring the typical 2.95% foreign transaction fee, making it an excellent choice for international travel and online shopping.
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-6 my-8">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      <span className="font-semibold">Advanced Security Controls:</span>{" "}
                      Take advantage of enhanced security features including instant card freezing, granular control over payment types (like online transactions or ATM withdrawals), and location-based security that can detect potentially fraudulent transactions based on your phone's location.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      <span className="font-semibold">Virtual Card Option:</span>{" "}
                      Access a virtual version of your credit card immediately upon approval, allowing you to make online purchases before your physical card arrives. This virtual card integrates seamlessly with digital wallets like Apple Pay and Google Pay.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      ...
                      Receive monthly and annual spending summaries that provide comprehensive breakdowns of your expenditure, helping you understand long-term financial patterns and make informed decisions about your spending habits.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      ...
                      Beyond the absence of foreign transaction fees, the Monzo Credit Card offers competitive exchange rates for international purchases, travel insurance options, and global emergency assistance, making it an ideal companion for frequent travelers.
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 my-8">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      ...
                      Access customer support directly through the Monzo app with their chat-based system, allowing you to resolve issues without phone calls or branch visits. This integration means support agents can see your transaction history (with your permission), enabling more efficient problem resolution.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      ...
                      Benefit from round-the-clock customer support for urgent matters, ensuring help is available whenever you need it, regardless of time zone or location.
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm leading-5">
                      ...
                      Access Monzo's active user community for peer-to-peer assistance and feature discussions, complementing the official support channels and providing alternative perspectives on how to maximize your Monzo experience.
                    </div>
                  </div>
                </div>
