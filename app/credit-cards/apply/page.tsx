...
export const metadata = {
  ...
  description: "Apply for a credit card online. Quick and secure application process with fast approval.",
  keywords: "credit card application, apply for credit card, online application, TopFinanzas",
}
      ...
      <section className="py-12 md:py-16 bg-gradient-to-b from-white to-gray-50">
        <div className="container-custom">
          ...
          <AnimatedText as="p" className="text-center mb-12 text-gray-600 max-w-3xl mx-auto" delay={0.1}>
            Complete the form below to apply for your selected credit card. Your information is secure and will only be
            used for processing your application.
          </AnimatedText>
