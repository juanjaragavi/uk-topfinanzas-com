...
// Define the interface for the Citi Double Cash page content
...
export const citiDoubleCashPageContent: CitiDoubleCashPageContent = {
  ...
  requirements: {
    ...
    items: [
      {
        label: "Credit Score",
        value: "A good credit score of at least 670 is generally recommended.",
      },
      {
        label: "Age Requirement",
        value: "Applicants should be 18 years or older.",
      },
      {
      ...
      },
      {
        ...
        value: "Proof of income or employment details is often necessary.",
      },
    ],
    image: {
  ...
  applicationSteps: {
    title: "How to apply for the Citi Double Cash Credit Card",
    steps: [
      {
        number: 1,
        title: "Visit Citi's official website",
        description:
      ...
      },
      {
        ...
        title: "Review terms",
        description:
          "Carefully review the terms and conditions, including interest rates, fees, and rewards program details.",
      },
      {
        number: 5,
  ...
  benefits: {
    title: "Benefits of the Citi Double Cash Credit Card",
    items: [
      {
        title: "Straightforward Cash-Back rewards",
        description:
          "With the Citi Double Cash Card, earn 1% cash back when you buy and another 1% when you pay off purchases. This unique structure encourages timely payments and offers cash-back simplicity.",
      },
      {
        title: "No annual fee",
        description:
          "With no annual fee, you can maximize rewards without worrying about costs. This feature makes it an accessible option for a range of users.",
      },
      {
        title: "Versatile redemption options",
        description:
          "Redeem cash-back rewards as statement credits, deposits, or checks, providing flexibility to suit different needs.",
      },
      {
        title: "Balance transfer feature",
        description:
          "Citi offers an introductory APR on balance transfers, which can be useful for consolidating debt. Keep in mind, however, that transfer fees may apply.",
      },
    ],
  },
  callToAction: {
