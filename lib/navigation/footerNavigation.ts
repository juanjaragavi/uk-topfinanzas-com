  ...
  categoryItems: [
    {
      ...
      href: "/personal-finance", // Updated path
    },
    {
      text: "Financial Solutions",
      href: "/financial-solutions", // Updated path
    },
    // Removed outdated categories
  ],

  /** Popular Articles section - Updated */
  blogItems: [
    ...
    {
      text: "Getting Out of Debt Guide",
      href: "/personal-finance/getting-out-of-debt", // Updated path & text
    },
    {
      text: "Barclaycard Avios Plus",
      href: "/financial-solutions/barclaycard-avios-plus", // Updated path & text
    },
    {
      text: "HSBC Personal Loan",
      href: "/financial-solutions/hsbc-personal-loan", // Updated path & text
    },
    // Removed outdated/less relevant links
  ],
