      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div className="order-1 md:order-1">
            <h2 className="text-xl font-semibold mb-5 text-[#7BDC54]">Navigate</h2>
          ...
          <div className="order-2 md:order-2">
            <h2 className="text-xl font-semibold mb-5 text-[#7BDC54]">Categories</h2>
            <ul className="space-y-3">
              <li>
                <Link 
          ...
          <div className="order-3 md:order-3">
            <h2 className="text-xl font-semibold mb-5 text-[#7BDC54]">Contact</h2>
            <ul className="space-y-3">
        ...
        <div className="text-center text-xs border-t border-white/20 pt-4">
          <p className="text-white/80">
            ...
            <Link href="/privacy-policy" className="text-[#55B9FF] hover:underline mx-2">
              Privacy Policy
            </Link> | 
