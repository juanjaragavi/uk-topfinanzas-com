...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  const width = React.useMemo(() => {
    return "70%"; // Use a static value instead of random to avoid hydration mismatch
  }, []);
...
SidebarRecentArticles.displayName = "SidebarRecentArticles";

// Categories component for sidebar
const SidebarCategories = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
...
// Newsletter subscription component for sidebar
const SidebarNewsletter = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div"> & {
...
SidebarNewsletter.displayName = "SidebarNewsletter";
